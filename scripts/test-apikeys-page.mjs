...
console.log('\n--- Navigating to /admin/api-keys ---');
await page.goto(`${BASE}/admin/api-keys`, { waitUntil: 'domcontentloaded', timeout: 60000 });
...
await page.screenshot({ path: 'scripts/apikeys-page.png', fullPage: true });
console.log('\n--- Events ---');
for (const e of events) console.log(JSON.stringify(e));

await browser.close();
console.log('\nScreenshot: scripts/apikeys-page.png');
