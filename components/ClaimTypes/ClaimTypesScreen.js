import classes from './claimtypes.module.css';
...
export default async function ClaimTypesScreen() {
    const date = new Date();
        ...
        <div className={classes.container}>
            ...
            <div className={classes.header}>
               <span>
                ...
                <span> <small>| &nbsp; Admin  &nbsp; | &nbsp; Claim Types &nbsp;</small> </span>
            ...
            <div className={classes.content}>
                ...
                <div className={classes.topCenter}>
                    <p className={classes.title}>Claim Types</p>
                    <ButtonFlexible
                        link="#"
                        width={100}
                        height={40}
