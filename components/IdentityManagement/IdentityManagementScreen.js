import classes from './identitymanagement.module.css';
...
export default async function IdentityManagementScreen() {
    const date = new Date();
        ...
        <div className={classes.container}>
            ...
            <div className={classes.content}>
                ...
                <div className={classes.topCenter}>
                    <p className={classes.title}>Identity Management</p>
                    <ButtonFlexible
                        link="#"
                        width={100}
                        height={40}
