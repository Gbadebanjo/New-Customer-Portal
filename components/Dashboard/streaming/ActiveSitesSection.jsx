 ...
 */
export default async function ActiveSitesSection({ assets, token, variant = 'sidebar' }) {
    let freshnessMap = {};
    ...
    return <ActiveSitesPanel assets={assets} freshnessMap={freshnessMap} variant={variant} />;
}
